...
export default function Shelf(props) {
  ...
  React.useEffect(() => {
    dispatch({ type: "SET_IMPORT_TYPE", payload: "obj" });
  }, [state.activeTab]);
      ...
      <div className="tab">
        <Label
          className={`
            ...
            `}
          onClick={event =>
            dispatch({ type: "SET_ACTIVE_TAB", payload: "inspector" })
          }
        >
          Inspector
        </Label>
        <Label
         ...
         `}
          onClick={event =>
            dispatch({ type: "SET_ACTIVE_TAB", payload: "scene" })
          }
        >
          Scene
        </Label>
        <Label
         ...
         `}
          onClick={event =>
            dispatch({ type: "SET_ACTIVE_TAB", payload: "import" })
          }
        >
          Import
        </Label>
